...
public sealed class DependencyManager
{
    ...
    public Task<Dictionary<DependencyMetadata, Type[]?>>? Load(IEnumerable<DependencyMetadata> targets)
    {
        if(_cache is null)
        {
            var b = ReGetPaths().GetAwaiter().GetResult();
    ...
    public Task<bool> InstallDependency(string path)
    {
        throw new NotImplementedException();
    }

    public Task<bool> UninstallDependency(string sourcePath)
    {
        throw new NotImplementedException();
    }
}
